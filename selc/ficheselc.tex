...
Note: dans le cas d'une utilisation console, du type \framed{\texttt{programA > destination}}, tout ce qui devait être écrit dans la sortie console ne s'affiche plus et est écrit dans destination. (partiel 2014, Q3, processus et fichier)
...
\end{lstlisting}
Supprime la dernière alarme, et si $\texttt{seconds} \neq 0$ rajoute une alarme dans \textt{seconds} secondes qui lancera le signal \textt{SIGALRM}.
